...
public class EasyVideoPlayer extends FrameLayout implements IUserMethods, TextureView.SurfaceTextureListener,
        ...
        MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnErrorListener, View.OnClickListener, DiscreteSeekBar.OnProgressChangeListener {

    @IntDef({LEFT_ACTION_NONE, LEFT_ACTION_RETRY})
    ...
    public static final int LEFT_ACTION_RETRY = 1;
    public static final int RIGHT_ACTION_NONE = 2;
    public static final int RIGHT_ACTION_SUBMIT = 3;
    ...
    private DiscreteSeekBar mSeeker;
    ...
    @LeftAction
    private int mLeftAction = LEFT_ACTION_RETRY;
    @RightAction
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mLeftAction = a.getInteger(R.styleable.EasyVideoPlayer_evp_leftAction, LEFT_ACTION_RETRY);
                //noinspection WrongConstant
    ...
    @Override
    public void setPromptTextRes(@StringRes int res) {
        setPromptText(getResources().getText(res));
    }

    @Override
    public void setPromptText(@Nullable CharSequence text) {
        mPromptText = text;
    ...
    protected void onFinishInflate() {
        ...
        mPrompt = (TextView) mControlsFrame.findViewById(R.id.prompt);
        mPrompt.setText(mPromptText);
